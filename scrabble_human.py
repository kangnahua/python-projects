...
WORDLIST_FILENAME = "scrabble_words.txt"
...
def updateHand(hand, word):
    ...
    for let in word:
        copy_hand[let] = copy_hand.get(let, 0) - 1
...
def isValidWord(word, hand, wordList):
    ...
    return fromWordList and ofLettersInHand
